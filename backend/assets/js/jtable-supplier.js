$(document).ready(function() {
    ...
    var makeJTable = function() {
	    ...
	    //pageSize: 50,
            ...
            actions: {
                listAction  : '/suppliers/list',
		createAction: '/suppliers/create',
		updateAction: '/suppliers/update',
		deleteAction: '/suppliers/destroy'
	    },
            fields: {
		prices: {
                    title: '',
			...
			var $img = $('<i class="child-opener-image fa fa-list" title="Show contacts" />');
				...
				$('#SupplierTableContainer').jtable('openChildTable', $img.closest('tr'), {
				    ...
				    actions: {
					listAction    : '/contacts/listByCompany?company='+suppliers.record.code,
